...
PERL = "/home/lucas/perl5/perlbrew/perls/perl-5.24.0/bin/perl" "-Iinc"
FULLPERL = "/home/lucas/perl5/perlbrew/perls/perl-5.24.0/bin/perl" "-Iinc"
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
pure_all :: $(INST_SCRIPT)/myapp_fastcgi.pl $(INST_SCRIPT)/myapp_test.pl $(INST_SCRIPT)/myapp_server.pl $(INST_SCRIPT)/myapp_create.pl $(INST_SCRIPT)/myapp_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/myapp_fastcgi.pl $(INST_SCRIPT)/myapp_test.pl \
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Lucas,,,</AUTHOR>' >> $(DISTNAME).ppd
